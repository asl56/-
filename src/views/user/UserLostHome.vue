<template>
  <div class="UserLostHome">
      ...
      <div class="UserLostHome_Search">
        <el-form :inline="true" :model="formInline" style="margin: 0px auto;">
          ...
          <el-form-item label="创建人">
            <el-select v-model="formInline.name" filterable placeholder="创建人">
    ...
    <el-dialog title="留言" :visible.sync="lostDialogFormVisible" @close="handleClose()">
      <el-form>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="lostDialogFormVisible = false">取 消</el-button>
