        ...
        <div class="MyLost_box">
            ...
            <div>
                ...
                <el-table :data="tableData" style="width: 90%;border-radius: 5px;margin: 0 auto;">
                    ...
                    <el-table-column prop="title" label="失物标题" width="250"
                        style="overflow: hidden;white-space: nowrap;text-overflow: ellipsis;">
                    </el-table-column>
                    ...
                    <el-table-column label="操作" fixed="right" width="250px">
                        <template slot-scope="scope">
                            <el-popconfirm confirm-button-text='确定' cancel-button-text='取消' icon="el-icon-info"
                                icon-color="red" title="确定要删除该条失物信息吗？" @confirm="handleDelete(scope.row)">
                ...
                <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
                    ...
                    layout="total, sizes, prev, pager, next, jumper" :total="total" class="MyLost_page">
                </el-pagination>
            </div>
...
export default {
    ...
    methods: {
        ...
        //删除物品
        handleDelete(row) {
            axios.get("/main/deleteLost", { params: { id: row.id } }).then(res => {
                this.$notify({
                    title: '成功',
                    message: '删除成功',
                    type: 'success',
